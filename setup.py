...
setup(
    ...
    description="Lightweight Cascoin Wallet",
    author="Cascoin Developers",
    author_email="support@cascoin.net",
    license="MIT Licence",
    url="https://cascoin.net",
    long_description="""Lightweight Cascoin Wallet based on Electrum""",
)
